...
#SBATCH --job-name=BCS_nofinetune_nolikes_notitles
...
python src/train.py  -mode train -dec_dropout 0.2 -sep_optim true -lr_bert 0.002 -lr_dec 0.2 -save_checkpoint_steps 2000 -batch_size 140 -train_steps 200000 -report_every 100 -accum_count 5 -finetune_bert false  -predict_title false -include_like_dist false -use_bert_emb true -use_interval true -warmup_steps_bert 20000 -warmup_steps_dec 10000 -max_pos 512 -visible_gpus 0  -log_file logs/nofinetune_nolikes_notitles.log
