...
python src/train.py -task abs -mode validate -batch_size 3000 -test_batch_size 500  -log_file logs/val_abs_5h_bert.log -sep_optim true -use_interval true -visible_gpus 0 -max_pos 512 -max_length 200 -alpha 0.95 -min_length 10 -result_path logs/macro_demo5hr.log 